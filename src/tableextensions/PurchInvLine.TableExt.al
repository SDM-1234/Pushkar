...
tableextension 50111 PurchInvLine extends "Purch. Inv. Line"
{
    fields
    {
        field(50100; "GST Amount"; Decimal)
        {
            ...
            CalcFormula = lookup("Detailed GST Ledger Entry"."GST Amount" where("Document Line No." = field("Line No."), "Document No." = field("Document No."), "Document Type" = const(Invoice)));
        }
        field(50101; "TDS Amount"; Decimal)
        {
            Caption = 'TDS Amount';
            FieldClass = FlowField;
            CalcFormula = lookup("TDS Entry"."TDS Amount" where("Document No." = field("Document No."), "Document Type" = const(Invoice)));
        }
