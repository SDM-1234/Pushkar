...
tableextension 50117 SalesInvoiceLine extends "Sales Invoice Line"
{
    fields
    {
        ...
        field(50101; "TCS Amount"; Decimal)
        {
            Caption = 'TCS Amount';
            FieldClass = FlowField;
            CalcFormula = sum("TCS Entry"."TCS Amount" where("Document No." = field("Document No."), "Document Type" = const("Invoice")));
        ...
        field(50102; "Invoice No."; Code[35])
        {
            Caption = 'Invoice No.';
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Invoice Header"."Reference Invoice No." where("No." = field("Document No.")));
